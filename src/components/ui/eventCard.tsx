        ...
        <div className={styles["event-info"]}>
          ...
          <div className={styles["event-price"]}>
            {event.price ? (
              ...
              >
                <path
                  d='M1.77778 2C0.797222 2 0 2.7474 0 3.66667V5.33333C0 5.5625 0.205556 5.74219 0.436111 5.81771C0.958333 5.98698 1.33333 6.45312 1.33333 7C1.33333 7.54688 0.958333 8.01302 0.436111 8.18229C0.205556 8.25781 0 8.4375 0 8.66667V10.3333C0 11.2526 0.797222 12 1.77778 12H14.2222C15.2028 12 16 11.2526 16 10.3333V8.66667C16 8.4375 15.7944 8.25781 15.5639 8.18229C15.0417 8.01302 14.6667 7.54688 14.6667 7C14.6667 6.45312 15.0417 5.98698 15.5639 5.81771C15.7944 5.74219 16 5.5625 16 5.33333V3.66667C16 2.7474 15.2028 2 14.2222 2H1.77778ZM3.55556 4.91667V9.08333C3.55556 9.3125 3.75556 9.5 4 9.5H12C12.2444 9.5 12.4444 9.3125 12.4444 9.08333V4.91667C12.4444 4.6875 12.2444 4.5 12 4.5H4C3.75556 4.5 3.55556 4.6875 3.55556 4.91667ZM2.66667 4.5C2.66667 4.03906 3.06389 3.66667 3.55556 3.66667H12.4444C12.9361 3.66667 13.3333 4.03906 13.3333 4.5V9.5C13.3333 9.96094 12.9361 10.3333 12.4444 10.3333H3.55556C3.06389 10.3333 2.66667 9.96094 2.66667 9.5V4.5Z'
                  fill='#19191B'
                />
              </svg>
            ) : null}
